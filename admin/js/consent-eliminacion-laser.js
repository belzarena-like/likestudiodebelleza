...
(function () {
    ...
    .then(consent => {
      ...
      if (consent.medical_conditions) {
        try {
          ...
          if (mc.age) document.getElementById('age').value = mc.age;
          if (mc.laser_type) document.getElementById('laser_type').value = mc.laser_type;
  ...
  form.addEventListener('submit', async e => {
    ...
    if (!fullName || !phone || !therapist || !service) {
    ...
    const payload = {
      ...
      personalized_risks: 'Consentimiento eliminación de tatuaje/micropigmentación con láser',
