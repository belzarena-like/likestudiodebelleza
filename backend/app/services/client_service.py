...
class ClientService:
    ...
    def create_or_update_client(
        db: Session, payload: schemas.ClientCreate
    ) -> models.Client:
    ...
    def search_clients(
        ...
        items, total = crud.search_admin_clients(
            db, query, with_consents, limit, offset
        )
    ...
    @staticmethod
    def get_client_prefill(
        db: Session, id_number: str
    ) -> schemas.AdminClientPrefillRead:
    ...
    def upsert_client_profile(
        db: Session, client_id: int, payload: schemas.ClientProfileUpsert
