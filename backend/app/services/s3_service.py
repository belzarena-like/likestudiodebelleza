...
class S3Service:
    ...
    def __init__(self):
        self.bucket = os.environ.get("S3_TRAINING_BUCKET", "likestudio-training-022499031203-eu-north-1-an")
    ...
    def generate_upload_url(self, filename: str, content_type: str = "video/mp4") -> Dict[str, str]:
    ...
    def generate_download_url(self, s3_key: str, s3_bucket: str, mime_type: str) -> Dict[str, any]:
